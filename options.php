 ...
 */
class AutomaticScheduledContent_Options {
	...
	public static function options_page() {
		...
		add_options_page(
			AutomaticScheduledContent::$asc_publish_label,
			AutomaticScheduledContent::$asc_publish_label,
			'manage_options',
			'tsu',
...
add_action( 'admin_init', array( 'AutomaticScheduledContent_Options', 'init' ) );
add_action( 'admin_menu', array( 'AutomaticScheduledContent_Options', 'options_page' ) );
// since this file gets included inside a `init` callback we can just call this function straight out.
AutomaticScheduledContent_Options::load_options();
